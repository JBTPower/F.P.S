...
Team Rotation Builder with file upload, flexible grouping, and AI Icebreakers.
"""
import csv
import io
import random
...
def render(storage, class_id: str):
    ...
    with st.expander("🤖 AI Icebreaker", expanded=False):
        if st.button("Generate AI Icebreaker", key="gen_icebreaker"):
